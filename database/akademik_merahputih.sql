...
--
-- Table structure for table `tbl_datappdb`
--

CREATE TABLE `tbl_datappdb` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `tbl_datappdb`
--
ALTER TABLE `tbl_datappdb`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tbl_datappdb`
--
ALTER TABLE `tbl_datappdb`
