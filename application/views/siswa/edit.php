                    ...
                    <div class="row">
                        <div class="col-sm-9">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control form-control-sm form-control form-control-sm" id="nis" name="nis" value="<?= $tbl_siswa['nis']; ?>" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-1">
                                    <input type="text" name="dari_bersaudara" id="dari_bersaudara" class="form-control form-control-sm" value="<?= $tbl_siswa['dari_bersaudara']; ?>">
                                </div>
