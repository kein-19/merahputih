    ...
    <div class="card mb-3">
        ...
        <div class="card-body ml-md-4">
            ...
            <div class="form-group row justify-content-end mt-sm-5">
                <div class="col-sm-3">
                    <a href="<?= base_url('siswa/edit/') . $tbl_siswa_baru['kode_pendaftaran']; ?>" class="print btn btn-primary btn-block" role="button">Edit</a>
                </div>
                <div class="col-sm-3">
                ...
                <div class="col-sm-3">
                    <a href="<?= base_url('siswa/delete/') . $tbl_siswa_baru['kode_pendaftaran']; ?>" class="print btn btn-danger btn-block tombol-hapus" role="button">Delete</a>
                </div>
            </div>
            <!-- /.container-fluid -->
